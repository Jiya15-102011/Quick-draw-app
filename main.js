...
document.getElementById("c").innerHTML="sketch to be drawn :"+sketch;
...
answer_holder="set";
score++;
document.getElementById("d").innerHTML="score: "+score;
    }
}
function x(){
...
console.log(error);
    ...
    document.getElementById("a").innerHTML="label :"+result[0].label;
    document.getElementById("b").innerHTML="confidence :"+Math.round(result[0].confidence*100)+"%";
...
timer_counter++;
document.getElementById("e").innerHTML="timer: "+timer_counter;
